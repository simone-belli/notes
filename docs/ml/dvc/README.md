...
:   `dvc.yaml` stages as a dependency graph, where the file goes, where parameters are defined and interpolated, `dvc repro`'s hash-based staleness check, `dvc.lock`, and metric/param diffs
