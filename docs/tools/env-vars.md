...
**Shell-scoped, any terminal:** see [direnv.md](direnv.md) — hooks the shell's directory-change event so variables export automatically in any terminal, not just one editor's integrated shell.
