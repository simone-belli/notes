...
Primary use case: preventing `asyncio.gather()` from firing hundreds of requests simultaneously — see [aiohttp.md](../../libraries/http-clients/aiohttp-concurrency.md#concurrent-requests).
...
- [aiohttp.md](../../libraries/http-clients/aiohttp.md) — async HTTP client built on asyncio
