...
For constraining strategies to match domain rules, generating structured/dependent data, and reproducing a specific failure deterministically, see [hypothesis-advanced.md](hypothesis-advanced.md).
